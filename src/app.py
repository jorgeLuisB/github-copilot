...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming lessons and endurance training",
    ...
    "Drama Club": {
        "description": "Acting, improvisation, and performance practice",
    ...
    "Science Club": {
        "description": "Hands-on experiments and STEM discovery projects",
